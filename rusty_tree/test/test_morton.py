...
def test_parent():
    ...
    key = MortonKey.from_anchor([(1 << DEEPEST_LEVEL) - 1, (1 << DEEPEST_LEVEL) - 1, (1 << DEEPEST_LEVEL) - 1])
    ...
    while key.level > 1:
        ...
        actual_trailing_zeros = count_trailing_zero_bits(key.morton >> LEVEL_DISPLACEMENT)
...
def test_ancestor_descendent():
    ...
    anchor = [(1 << DEEPEST_LEVEL) - 1, (1 << DEEPEST_LEVEL) - 1, (1 << DEEPEST_LEVEL) - 1]
